...
**Get All or Multiple Playlists**  
 ...
 - Permits an `noRender` parameter, where if set, only playlist details will be returned. If not set, full song objects will be returned in the songs array.  
...
GET /playlists?noRender={anything}
```
```js
curl -X GET "/playlists?limit=1&noRender=1&isNamed=1"
   ...
   "playlists":[
      {
         ...
         "details":{
            ...
            "features":[
               "6067f91f27e1ac000d5a39bb",
               "6067f92127e1ac000d5a39c9",
               "6067f92327e1ac000d5a39d0"
            ]
         },
         "private":false,
         "links":[
...
```js
GET /playlists/{id}
GET /playlists/{id}?noRender={anything},
```

```js
curl -X GET "/playlists/6067f9e327e1ac000d5a3a3a?noRender=1"
   ...
   "playlists":[
      {
         ...
         "details":{
            ...
            "features":[
               "6067f9d427e1ac000d5a39fe",
               "6067f9d627e1ac000d5a3a03",
               "6067f92227e1ac000d5a39ca"
            ]
         },
         "private":false,
         "links":[
