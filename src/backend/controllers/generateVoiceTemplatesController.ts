...
const voiceLines = [
	...
	new VoiceLineTemplateAutofill([], "Weclome back to GCS Radio, starting off is $NEXT_TITLE by $NEXT_ARTIST", VoiceLineType.intro),
	...
	new VoiceLineTemplateAutofill([], "Check out GCS Radio gitHub for more exciting features, I hope you'll join me, there is absolutely no cost to listen to this and I won't try to get to your phone to sell you something. When I listen to music, I listen to it for music's sake. No bad feelings or agenda, just pure music. How can you go wrong with that? Thank you so much for being here, once again, have a great day. Anyway. Back to music. Here's $NEXT_TITLE", VoiceLineType.normal),
